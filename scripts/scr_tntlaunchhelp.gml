...
_x=(room_width/2)-150
_y=(room_height/2)-75
draw_text_transformed(_x,_y+yy[1],"TNT",.5,.5,0)
...
draw_sprite(spr_tutblock,0,_x+16,_y+yy[5])
draw_sprite(spr_tutblock,0,_x+32,_y+yy[3])
draw_sprite(spr_tutblock,0,_x-32,_y+yy[5])

//draw_sprite(spr_signarrow,blink,_x+32,_y+yy[5]-32)
draw_sprite_ext(spr_signarrow,blink+1,_x,_y+yy[5]-32,1,1,0,c_white,1)

draw_sprite_ext(spr_bulet1,0,_x-32,_y+yy[5]-32,1,1,180,c_white,1)
draw_sprite_ext(spr_bulet1,0,_x-32,_y+yy[5]-16,1,1,45,c_white,1)
draw_sprite_ext(spr_bulet1,0,_x-16,_y+yy[5]-16,1,1,90,c_white,1)
draw_sprite_ext(spr_bulet1,0,_x-16,_y+yy[5]-32,1,1,125,c_white,1)
draw_sprite_ext(spr_bulet1,0,_x-24,_y+yy[5]-24,1,1,273,c_white,1)

draw_sprite_ext(spr_player_1idle,0,_x+32,_y+yy[5]-32,2,2,0,c_white,1)
...
draw_set_color(c_white)
draw_set_alpha(1)
draw_text_transformed(_x,_y+yy[1],"Rapid_Fire!",.5,.5,0)
draw_set_color(c_black)
draw_set_alpha(0.9)
draw_rectangle(_x-64,_y+yy[2]+32,_x+64,_y+yy[2]+128,false)
draw_sprite_ext(spr_rapid_fire,0,_x,_y+yy[3]+64+16,1,1,0,c_white,1)
