...
draw_set_color(c_white)
draw_set_alpha(1)
draw_text_transformed(_x,_y+yy[4],"Missle",.5,.5,0)
draw_set_color(c_black)
draw_set_alpha(0.9)
...
_x=(room_width/2)-75
_y=(room_height/2)+32
draw_sprite_ext(spr_rockettut,0,_x+64+12,_y+yy[5]-28,1,1,0,c_white,1)
...
draw_set_alpha(0.9)
draw_rectangle(_x-64,_y+yy[2]+32,_x+64,_y+yy[2]+128,false)
draw_sprite_ext(spr_boomtut,0,_x,_y+yy[3]+64+16,1,1,0,c_white,1)
