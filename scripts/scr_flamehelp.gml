...
_x=(room_width/2)-150
_y=(room_height/2)-75
draw_text_transformed(_x,_y+yy[1],"Input",.5,.5,0)
...
draw_set_color(c_white)
draw_set_alpha(1)
draw_text_transformed(_x,_y+yy[4],"OverHeat",.5,.5,0)
draw_set_color(c_black)
draw_set_alpha(0.9)
...
draw_text_transformed(_x+128+24,_y+yy[3],"=",2,2,0)
...
_x=(room_width/2)-75
_y=(room_height/2)+32
draw_sprite_ext(spr_overheat,0,_x+64+12,_y+yy[5]-28,1,1,0,c_white,1)
...
draw_set_color(c_white)
draw_set_alpha(1)
draw_text_transformed(_x,_y+yy[1],"Fire!",.5,.5,0)
draw_set_color(c_black)
draw_set_alpha(0.9)
draw_rectangle(_x-64,_y+yy[2]+32,_x+64,_y+yy[2]+128,false)
draw_sprite_ext(spr_firetut,0,_x,_y+yy[3]+64+16,1,1,0,c_white,1)
