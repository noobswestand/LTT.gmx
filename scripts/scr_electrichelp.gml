...
_x=(room_width/2)-150
_y=(room_height/2)-75
draw_text_transformed(_x,_y+yy[1],"Friction",.5,.5,0)
...
draw_sprite_ext(spr_signarrow,blink+1,_x-32,_y+yy[5]-32,1,1,180,c_white,1)

draw_sprite_ext(spr_player_1idle,0,_x,_y+yy[5]-32,2,2,0,c_white,1)
...
draw_set_color(c_white)
draw_set_alpha(1)
draw_text_transformed(_x,_y+yy[1],"Electricity!",.5,.5,0)
draw_set_color(c_black)
draw_set_alpha(0.9)
draw_rectangle(_x-64,_y+yy[2]+32,_x+64,_y+yy[2]+128,false)
draw_sprite_ext(spr_tutlightbulb,0,_x,_y+yy[3]+64+16,2,2,0,c_white,1)
