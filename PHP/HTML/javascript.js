function KeyPress(e) {
      ...
      if (evtobj.keyCode == 66 && evtobj.ctrlKey){
		var loc="http://dl.dropboxusercontent.com/u/31562044/PIZZASENORIDIDITexport/index.html";
		document.getElementById('bod0').setAttribute('src', loc);
...
document.addEventListener("DOMContentLoaded", function(event) { 
	...
	height=height/2;
	document.getElementById('body0').setAttribute("style","height:"+height.toString()+"px");
});
